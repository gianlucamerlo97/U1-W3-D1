...
function concatStrings(string1, string2) {
  const a = string1.substr(0, 2);
  const b = string2.substr(string2.length - 3);
  const result = (a + b).toUpperCase();
  return result;
}
console.log(concatStrings("Giga", "Chad"));
/* ESERCIZIO 2 (for)
...
*/
const evenNumbers = elements.filter((element) => element % 2 === 0);
